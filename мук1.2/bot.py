...
# ======================
# Вспомогательная функция для форматирования списка задач
# ======================
...
# ======================
# Команда /today — задачи за сегодня
# ======================
...
async def cmd_today(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        today_tasks = [
            ...
            if r.get("Дата создания") == today
        ]
        message = format_task_list(today_tasks, f"Задачи за {today}")
    except Exception as e:
    ...
    try:
        ...
        await update.message.reply_text("⚠️ Не удалось отправить отчёт. Напишите боту в личку /start.")

# ======================
# Команда /pending — нераспределённые задачи
# ======================
...
async def cmd_pending(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        message = format_task_list(pending_tasks, "Нераспределённые задачи")
    except Exception as e:
...
def main():
    ...
    logger.info("Бот запущен (Канал + Чат обсуждений с командами и правильными уведомлениями)...")
